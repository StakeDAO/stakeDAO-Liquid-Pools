...
contract StakeCapitalTemplate is BaseTemplate, TokenCache {
    ...
    // bytes32 constant internal REWARDS_ID = namehash("rewards.aragonpm.eth");
    ...
    // bytes32 constant internal TOKEN_WRAPPER_ID = namehash("token-wrapper.open.aragonpm.eth"); for local deployment
    bytes32 constant internal TOKEN_WRAPPER_ID = 0x1fda7985bca2bed0615ee04a107b3262fe2a24b5ad427f2e8ef191a446d7841b;

    // bytes32 constant internal TOKEN_WRAPPER_ID = namehash("token-wrapper.hatch.aragonpm.eth"); for rinkeby/mainnet deployment
//    bytes32 constant internal TOKEN_WRAPPER_ID = 0xdab7adb04b01d9a3f85331236b5ce8f5fdc5eecb1eebefb6129bc7ace10de7bd;
